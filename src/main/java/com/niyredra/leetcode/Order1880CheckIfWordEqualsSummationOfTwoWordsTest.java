...
public class Order1880CheckIfWordEqualsSummationOfTwoWordsTest {

    @Test
    public void asciiTest(){
        String abcdefghij = "abcdefghij";
        abcdefghij.chars().map(c -> c - 97).forEach(System.out::print);
        System.out.println();
        System.out.println(abcdefghij.chars().map(c -> c - 97).sum());
    }
