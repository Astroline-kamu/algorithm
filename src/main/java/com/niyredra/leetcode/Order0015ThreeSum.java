        ...
        public static void main(String[] args) {
            TimeUtils.printTime("Solution2_3_Chart1", () -> {
                ...
                for (List<Integer> list :
                        listList) {
                    idx.getAndIncrement();
//                    if (idx.get() % 240 != 0 ) continue;
//                    if (idx.get() > 36) continue;  // 这个的图像还挺好玩的
        ...
        public static List<List<Integer>> threeSum(int[] nums) {
            ...
            for (int i = 0; i < nums.length; i++) {
                for (int j = i + 1; j < nums.length; j++) {
                    ...
                    if (Arrays.binarySearch(nums, j + 1, nums.length, x) > 0) {  // binarySearch如果查不到值的话，会返回 -(Array.length)，所以一定小于0
        ...
        public static List<List<Integer>> threeSum(int[] nums) {
            ...
            for (int i = 0; i < nums.length; i++) {
                ...
                for (int j = i + 1; j < nums.length; j++) {
                    ...
                    if (map.containsKey(x)) {
                        res.add(
                                Stream.of(new Integer[]{nums[i], nums[j], x})
                                        .sorted()
                                        .toList()
                        );
                    }
    ...
    /**
     * 时间 Timeout
     * same at sample case ... 用时 4015 Ms
     */
    static class Solution1_2 {
            ...
            for (int i = 0; i < nums.length; i++) {
                for (int j = i + 1; j < nums.length; j++) {
                    ...
                    for (int k = j + 1; k < nums.length; k++) {
                        if (k == i || k == j) continue;
                        if (x == nums[k]) res.add(
                                Stream.of(new Integer[]{nums[i], nums[j], nums[k]})
                                        .sorted()
                                        .toList()
                        );
                    }
        ...
        public static void main(String[] args) {
            ...
            List<List<Integer>> listList = Objects.requireNonNull(Solution1_2.threeSum(sample));
//            listList.forEach(System.out::println);
            System.out.println(listList.size());
            System.out.println(new Date().getTime() - begin + "Ms");
        }
    }
    ...
    static class Solution1_1 {
        public static List<List<Integer>> threeSum(int[] nums) {
            ...
            for (int i = 0; i < nums.length; i++) {
                for (int j = i + 1; j < nums.length; j++) {
                    int x = target - (nums[i] + nums[j]);
                    // if x exist in nums && nums[i]
                    for (int k = j + 1; k < nums.length; k++) {
                        if (k == i || k == j) continue;
                        if (x == nums[k]) {
                            List<Integer> list = List.of(new Integer[]{nums[i], nums[j], nums[k]});
                            list = list.stream().sorted().toList();
                            for (List<Integer> il :
                                    res) {
                                count++;
                                if (il.toString().equals(list.toString())) {
                                    list = null;
                                    break;
                                }
                            }
